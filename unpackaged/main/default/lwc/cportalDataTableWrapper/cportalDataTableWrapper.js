...
import getRecords from "@salesforce/apex/CPortal_DataTableWrapperController.getRecords";
import getFieldDetails from "@salesforce/apex/CPortal_DataTableWrapperController.getFieldDetails";

export default class cportalDataTableWrapper extends LightningElement {
  @track allRecords;
        ...
        if (result) {
          ...
          for (var index in result) {
            ...
            allRecords.forEach(
              (item) =>
              (item["RecordURL"] =
                "/lightning/r/Communications_Content__c/" + item["Id"] + "/view")
            );
